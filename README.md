...
**Table of Contents**
  ...
  - [5. Features and Models](#5-features-and-models)
    - [5.1 Rating](#51-rating)
    - [5.2 Sentence Similarity between Query Text and Book Titles](#52-sentence-similarity-between-query-text-and-book-titles)
    - [5.3 Existence of Author(s) in Query Text](#53-existence-of-authors-in-query-text)
  ...
  - [8. Other Things to Try](#8-other-things-to-try)
    - [8.1 Typo Detection](#81-typo-detection)
...
### 5.2 Sentence Similarity between Query Text and Book Titles
...
### 5.3 Existence of Author(s) in Query Text
...
Of course, cleaning on author names is required, as some authors have non-English names, and we should not require, or expect, the user to type the full name. However, such a method does not allow for typo correction, which we will discuss more in [Section 8.1](#81-typo-detection). \
...
One disadvantage of this metric is that users have to be willing to fill out the survey and be honest, which is not the case in real life. Thus, we will purpose a second metric.
